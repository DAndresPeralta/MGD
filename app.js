...
import { auth, auth2 } from "./middlewares/auth.middleware.js";
...
mongoose
  .connect(
    "mongodb+srv://devdap:a156624942@cluster0.yd9rnfa.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
  )
  .then(() => {
